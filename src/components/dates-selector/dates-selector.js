...
const $arrival = $('.dropdown_theme_date:first-child .dropdown__input');
const $departure = $('.dropdown_theme_date:nth-child(2) .dropdown__input');
const $icon = $('.dropdown_theme_date .dropdown__arrow');
