...
$('.header__burger').click(
  () => {
    $('.header__ul-wrap').toggleClass('header__ul-wrap_show');
    $('.header__login-container').toggleClass('header__login-container_show');
    $('.header__login-container-logged').toggleClass('header__login-container_show');
    $('.header__burger-line_burger').toggleClass('header__burger-line_hide');
    $('.header__burger-line_cross-1').toggleClass('header__burger-line_show');
    $('.header__burger-line_cross-2').toggleClass('header__burger-line_show');
  },
);
